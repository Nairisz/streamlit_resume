...
with col2:
    ...
    st.write("**Email:** norizzaty.work@gmail.com")
...
*Infrasel Sdn. Bhd.*    
*Feb 2026 - Current*
- Supported IT operations through workstation setup, user onboarding, IT asset management, inventory tracking, and web development activities using Laravel.
